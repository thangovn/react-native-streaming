...
var withHostLiveStreaming = function (WrappedComponent) {
    var HostLiveStreaming = /** @class */ (function (_super) {
        __extends(HostLiveStreaming, _super);
        function HostLiveStreaming() {
            ...
            _this.state = {
                ...
                isHost: true,
                switchCamera: true,
                connectionState: react_native_agora_1.ConnectionStateType.Connecting,
                errInit: null,
            };
            ...
            _this._startCall = function (channelName, uid) { return __awaiter(_this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, ((_a = this._engine) === null || _a === void 0 ? void 0 : _a.joinChannel(this.state.token, channelName, null, uid))];
                        case 1:
                            _b.sent();
                            return [2 /*return*/];
                    }
            ...
            _this.init = function (appId) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, react_native_agora_1.default.create(appId).catch(function (err) {
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this._engine.startPreview()];
                        case 3:
                            // Enable the local video preview.
                            _b.sent();
                            return [4 /*yield*/, this._engine.setBeautyEffectOptions(true, {})];
                        case 4:
                            _b.sent();
                            // await this._engine.enableVirtualBackground(true, {});
                            // Set the channel profile as live streaming.
                            return [4 /*yield*/, this._engine.setChannelProfile(react_native_agora_1.ChannelProfile.LiveBroadcasting)];
                        case 5:
                            // await this._engine.enableVirtualBackground(true, {});
                            // Set the channel profile as live streaming.
                            _b.sent();
                            // Set the usr role as host.
                            return [4 /*yield*/, this._engine.setClientRole(react_native_agora_1.ClientRole.Broadcaster)];
                        case 6:
                            // Set the usr role as host.
                            _b.sent();
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, this._engine.muteAllRemoteAudioStreams(true)];
                                        case 1:
                                            _a.sent();
                                            return [4 /*yield*/, this._engine.muteAllRemoteVideoStreams(true)];
                                        case 2:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
        ...
        HostLiveStreaming.prototype.componentDidMount = function () {
            if (deviceInfo_1.isAndroid) {
                (0, permissions_1.requestCameraAndAudioPermission)().then(function () {
                    // console.log('requested!');
                });
            }
            this.backHandler = react_native_1.BackHandler.addEventListener('hardwareBackPress', this.backAction);
        };
        HostLiveStreaming.prototype.componentWillUnmount = function () {
            this.backHandler.remove();
        };
        HostLiveStreaming.prototype.render = function () {
            return (react_1.default.createElement(WrappedComponent, __assign({}, this.props, this.state, { init: this.init, startCall: this._startCall, endCall: this._endCall, switchCamera: this._switchCamera })));
        };
        return HostLiveStreaming;
    }(react_1.default.PureComponent));
    return HostLiveStreaming;
};
exports.default = withHostLiveStreaming;
